...
public class JakartaWebContext extends WebContext {
   ...
   public JakartaWebContext(String url, Path warDirectory, String warFile, Path temporaryWarDir, String virtualHost) {
      ...
      webapp.addFilter(new FilterHolder(JakartaJolokiaFilter.class), "/*", EnumSet.of(DispatcherType.INCLUDE, DispatcherType.REQUEST));
      webapp.addFilter(new FilterHolder(JakartaAuthenticationFilter.class), "/auth/login/*", EnumSet.of(DispatcherType.REQUEST));
      ...
      webapp.setVirtualHosts(List.of(new String[]{virtualHost}));
   }
   ...
   /** With the adoption of support for RFC 6265, this method should no longer be used.
      we dont have to set the __SAME_SITE_STRICT__ comment
    */
   @Override
